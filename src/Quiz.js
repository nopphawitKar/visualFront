  ...
  render() {
    return (
      <div className="Quiz">
        ...
        {this.state.currentQuizGroup==0 && <Understandability setScores={this.updateScores.bind(this)} graphdata={this.props.understanding}/>}
        {this.state.currentQuizGroup==1 && <Learnability setScores={this.updateScores.bind(this)} graphdata={this.props.learning}/>}
      </div>
    );
  }
}
